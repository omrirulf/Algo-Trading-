...
Coverage
--------
journal lines read        337
entries                   337
  produced a signal       337
  directional             52  (NEUTRAL: 285)
  scored                  0
  unscored, pending         52  (too recent — no outcome yet)
...
from the first cycle onward.
  ...
  all dimensions agree   n=115   mean conviction 0.267
  at least one dissents  n=222   mean conviction 0.295
  gap -0.028 — conviction is HIGHER when dimensions conflict — the opposite of the instruction
  rank corr, score spread vs conviction: +0.41 (n=337) (negative is correct)
...
A model that creeps toward always-confident makes the floor a no-op.
  ...
  first half   n=168   mean 0.294  above floor 42.3%
  second half  n=169   mean 0.276  above floor 26.6%
  change -0.018

Input health
------------
  cycles with a context gap  0/337 (0.0%)

  bias distribution (337 signals)
    BULLISH       19  5.6%
    BEARISH       33  9.8%
    NEUTRAL      285  84.6%
