...
| 2026-09-25 | **Reporting only** (exploratory) | Asked by the owner. The race also prints, from 2026-09-23, each arm's trades by conviction group (0.30-0.40, 0.40-0.50, 0.50-0.60, 0.60 and above) and split into longs and shorts, with the number of trades, the mean net return and the hit rate, and "too few" until a group or side has 20 trades. Shown on the 4 Funds page too. They decide nothing and change no rule. |
